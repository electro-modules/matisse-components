...
JS;
  ...
  protected function render ()
  {
    ...
    $options = JavascriptCodeGen::makeOptions ([
      ...
      'dictInvalidFileType'          => '$DROPZONE_DICT_INVALID_FILETYPE',
      'dictFileTooBig'               => '$DROPZONE_DICT_FILE_TOO_BIG',
      'dictResponseError'            => '$DROPZONE_DICT_RESPONSE_ERROR',
      'dictCancelUpload'             => '$DROPZONE_DICT_CANCEL_UPLOAD',
      'dictCancelUploadConfirmation' => '$DROPZONE_DICT_CANCEL_UPLOAD_CONFIRMATION',
      'dictRemoveFile'               => '$DROPZONE_DICT_REMOVE_FILE',
      'dictMaxFilesExceeded'         => '$DROPZONE_DICT_MAX_FILES_EXCEEDED',
